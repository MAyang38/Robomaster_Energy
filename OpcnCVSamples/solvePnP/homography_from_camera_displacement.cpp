...
//! [compute-c2Mc1]
    ...
    void homographyFromCameraDisplacement(const string &img1Path, const string &img2Path, const Size &patternSize,
        ...
        //! [compute-poses]
        vector<Point2f> corners1, corners2;//!二维角点
        bool found1 = findChessboardCorners(img1, patternSize, corners1);//!棋盘图上寻找二维角点
        ...
        vector<Point3f> objectPoints;//!三维角点
        calcChessboardCorners(patternSize, squareSize, objectPoints);//!在棋盘图上检测三维角点

        FileStorage fs(intrinsicsPath, FileStorage::READ);//!读取参数表
