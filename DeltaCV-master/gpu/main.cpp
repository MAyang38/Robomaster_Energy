...
//        showHistImage(histImg,hist_cpu,256);
        equalizeHist_gpu(gray_gpu, hist_gpu, sum_ni, histGray_gpu, IMAGE_ROWS, IMAGE_COLS, threadsPerBlock,
                         blockPerGrid);
        cudaDeviceSynchronize();
...
//        cout<<"----------"<<endl;
//        showHistImage(histImg,hist_cpu,256);
        cudaMemcpy(histGray.data, histGray_gpu, IMAGE_ROWS * IMAGE_COLS * sizeof(unsigned char),
